...
function requireReactDomClient_production() {
  ...
  function preinitScript(src, options2) {
    ...
    if (ownerDocument && src) {
      var scripts2 = getResourcesFromRoot(ownerDocument).hoistableScripts, key = getScriptKey(src), resource = scripts2.get(key);
      resource || (resource = ownerDocument.querySelector(getScriptSelectorFromKey(key)), resource || (src = assign({ src, async: true }, options2), (options2 = preloadPropsMap.get(key)) && adoptPreloadPropsForScript(src, options2), resource = ownerDocument.createElement("script"), markNodeAsHoistable(resource), setInitialProperties(resource, "link", src), ownerDocument.head.appendChild(resource)), resource = {
        type: "script",
        instance: resource,
        count: 1,
        state: null
      }, scripts2.set(key, resource));
    }
  }
...
const name = "@holiday-jp/holiday_jp";
const version = "2.5.1";
const description = "Japanese holidays";
const main = "lib/holiday_jp.js";
const types = "lib/holiday_jp.d.ts";
const files = ["lib"];
const scripts = { "test": "node --test ./test/*.js", "generate": "git submodule update; cd holiday_jp/; git fetch origin master; git reset --hard origin/master; cd ../; node -r esbuild-register scripts/generate.ts", "build": "tsc && webpack && es-check es2015 lib/*.js release/*.js" };
const repository = { "type": "git", "url": "https://github.com/holiday-jp/holiday_jp-js" };
const keywords = ["holidays"];
const author = "Ken'ichiro Oyama";
const license = "MIT";
const bugs = { "url": "https://github.com/holiday-jp/holiday_jp-js/issues" };
const homepage = "https://github.com/holiday-jp/holiday_jp-js";
const devDependencies = { "@playwright/test": "^1.48.0", "es-check": "^9.1.2", "esbuild-register": "^3.6.0", "js-yaml": "^3.13.1", "moment": "^2.23.0", "typescript": "^5.8.3", "webpack": "^5.91.0", "webpack-cli": "^6.0.1" };
const require$$0 = {
  name,
  version,
  description,
...
var holidays_1;
var hasRequiredHolidays;
function requireHolidays() {
  if (hasRequiredHolidays) return holidays_1;
  hasRequiredHolidays = 1;
  const holidays = {
    "1970-01-01": {
      date: "1970-01-01",
      week: "木",
...
var holiday_jp_1;
var hasRequiredHoliday_jp;
function requireHoliday_jp() {
  if (hasRequiredHoliday_jp) return holiday_jp_1;
  hasRequiredHoliday_jp = 1;
  var __importDefault = holiday_jp_1 && holiday_jp_1.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : { "default": mod };
  };
  const package_json_1 = __importDefault(require$$0);
  const holidays_12 = __importDefault(requireHolidays());
  const format_1 = __importDefault(requireFormat());
  const holiday_jp = {
    VERSION: package_json_1.default.version,
    holidays: holidays_12.default,
    /**
    ...
    between: function(start, end) {
      ...
      const selected = [];
      Object.keys(holidays_12.default).forEach((date) => {
        const holiday = holidays_12.default[date];
    ...
    isHoliday: function(date) {
      ...
      return Object.keys(holidays_12.default).includes(date);
    }
  };
  holiday_jp_1 = holiday_jp;
  return holiday_jp_1;
}
var holiday_jpExports = requireHoliday_jp();
const getHolidayName = (date) => {
  const lists = holiday_jpExports.between(date, date);
  return lists[0]?.name ?? null;
};
const buildCalendarData = (currentDate) => {
  const year = currentDate.getFullYear();
  const month = currentDate.getMonth();
  const lastDay = new Date(year, month + 1, 0).getDate();
  const weeks = [];
  let week = Array.from({ length: new Date(year, month, 1).getDay() }, () => null);
...
const Header = ({ date, onPrevClick, onNextClick }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "calendar-header__row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "calendar-header__cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("th", { className: "calendar-header__cell calendar-header__cell--text", colSpan: 5, children: [
      date.getFullYear(),
      "/",
      date.getMonth() + 1
    ] }),
...
const Cell = ({ calendar }) => {
  const title = calendar?.holidayName ?? void 0;
  const classes = buildClasses(calendar);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: classes, title, children: calendar?.date.getDate() });
};
const createKey = (calendar, index) => {
  if (calendar !== null) {
...
const Week = ({ week }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "calendar-body__row", children: week.map((calendar, index) => {
    const key = createKey(calendar, index);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { calendar }, key);
  }) });
};
const Calendar = ({ initialDate }) => {
  const [date, setDate] = reactExports.useState(() => initialDate);
  const weeks = buildCalendarData(date);
  const onPrevClick = reactExports.useCallback(() => {
    setDate((currentDate) => {
      return new Date(currentDate.getFullYear(), currentDate.getMonth() - 1, 1);
    });
  }, []);
  const onNextClick = reactExports.useCallback(() => {
    setDate((currentDate) => {
      return new Date(currentDate.getFullYear(), currentDate.getMonth() + 1, 1);
    });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "calendar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "calendar-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { date, onPrevClick, onNextClick }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "calendar-body", children: weeks.map((week, index) => {
      const key = `${date.getFullYear()}-${date.getMonth()}-${index}`;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Week, { week }, key);
    }) })
  ] });
};
const App = () => {
  const date = /* @__PURE__ */ new Date();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { initialDate: date }) });
};
const container = clientExports.createRoot(document.getElementById("root"));
container.render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}));
